...
const AboutDialog = (props) => {
  const closeDialog = () => props.store.set("isAboutDialogOpen", false);

  return (
    <Transition appear show={props.isAboutDialogOpen} as={Fragment}>
      <Dialog
        as="div"
            ...
            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Commit-Man is a VCS made by Souris Ash and Atharva Gundawar.
                </p>
              </div>
...
export default withStore(AboutDialog, ['isAboutDialogOpen']);
